...
// sub_1428403B0 is in water
DEFINE(Sigs::actor::isInWater, "48 89 5C 24 ? 57 48 81 EC ? ? ? ? 48 8B D9 E8 ? ? ? ? 48 8B B8")//48 89 5C 24 ? 57 48 81 EC ? ? ? ? 48 8B D9 E8 ? ? ? ? 48 8B B8 //sub_1426473B0
DEFINE(Sigs::actor::getHealth, "48 83 EC ? 8B 41 ? 48 8D 54 24 ? 48 8B 49 ? 89 44 24 ? E8 ? ? ? ? 48 85 C0 75 ? 48 83 C4 ? C3 8B 15 ? ? ? ? 48 8B C8 E8 ? ? ? ? F3 0F 10 88 ? ? ? ? F3 0F 2C C1 66 0F 6E C0 8D 48 ? 0F 5B C0 0F 2F C1 0F 42 C1 48 83 C4 ? C3 CC CC CC CC CC CC CC CC CC CC CC CC CC CC 48 83 EC")//E8 ? ? ? ? C7 85 ? ? ? ? ? ? ? ? C7 85 ? ? ? ? ? ? ? ? 66 C7 85 ? ? ? ? ? ? 0F 57 C0
//player
